Feature: UC8 View Access Log By Date
  ...
  Scenario: 
    ...
    Then Row 1 should be Justin Time. Emergency Responder. View emergency report.
	Then Row 2 should be Kelly Doctor. LHCP. Edit Office Visits.
	Then Row 3 should be Kelly Doctor. LHCP. View risk factors.